...
if (create) {
      ...
      // Your code for creating a table goes here
            ...
            CREATE TABLE IF NOT EXISTS npctable (
    ...
    const tableName = 'npctable'; // Replace with the name of the table to delete
    ...
    db.query(deleteQuery, (err, result) => {
      ...
      const query = 'SELECT * FROM npctable ORDER BY notify'; // Replace with your table name
